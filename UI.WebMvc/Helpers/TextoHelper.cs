...
namespace UI.WebMvc.Helpers
{
    ...
    {
        public static HtmlString TextoConLabel(string id, string NombreLabel,string tipo,string valor,string lenghControl)
        {
         var cadena = string.Format(
             ...
             "</div>", id, tipo, NombreLabel,valor,lenghControl );
